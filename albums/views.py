...
############## index ##############
def index(request):
    return HttpResponseRedirect(reverse('albums:post_list'))
...
class PostList(ListView):
    model = Post
    template_name = 'albums/post/post_list.html'
...
class PostDetail(DetailView):
    model = Post
    template_name = 'albums/post/post_detail.html'
    context_object_name = 'post'

    def get_context_data(self, **kwargs):
        # Call the base implementation first to get a context
        context = super().get_context_data(**kwargs)
        # if user is authenticated and he is the owner of the post
...
class PostCreate(LoginRequiredMixin, CreateView):
    model = Post
    template_name = 'albums/post/post_form_create.html' 
...
class PostUpdate(LoginRequiredMixin, UpdateView):
    model = Post
    template_name = 'albums/post/post_form_update.html' 
    fields = ['title', 'image', 'tags']
...
class PostDelete(LoginRequiredMixin, DeleteView):
    model = Post
    template_name = 'albums/post/post_confirm_delete.html' 
    success_url = reverse_lazy('albums:post_list')
